...
import com.example.wemedia.mapper.WmSensitiveMapper;
...
public class WmNewsAutoScanServiceImpl implements WmNewsAutoScanService {
    ...
    public void autoScanWmNews(Integer id) {
        ...
        if(wmNews.getStatus().equals(WmNews.Status.SUBMIT.getCode())){
            ...
            //2.审核文本内容  阿里云接口(阿里云内容安全接口不再免费开放，所以直接写死)
            boolean isTextScan = handleTextScan((String) textAndImages.get("content"),wmNews);
            if (!isTextScan) {
                return;
            }
            //3.审核图片  阿里云接口(阿里云内容安全接口不再免费开放，所以直接写死)
    ...
    /**
     * 审核图片内容  阿里云接口(阿里云内容安全接口不再免费开放，所以直接写死)
     * @param images
     * @param wmNews
     * @return
     */
    ...
    /**
     * 审核文本内容  阿里云接口(阿里云内容安全接口不再免费开放，所以直接写死)
     * @param content
     * @param wmNews
     * @return
     */
    ...
    /**
     * 修改文章内容(阿里云自动审核后，根据审核结果修改文章的status与reason字段)
     * @param wmNews
     * @param status
     * @param reason
     */
